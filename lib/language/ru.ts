export const russian = {
  ...
  SUPPORT_DESCRIPTION_1:
    'Если вы застряли на каком-то вопросе, вы всегда можете получить подсказку или пропустить его.',
  SUPPORT_DESCRIPTION_2: 'Но помните, что это будет стоить вам очков.',
  SUPPORT_DESCRIPTION_3:
    'Для этого сначала введите ответ в поле ввода, а затем нажмите на кнопку подсказки или флага.',
  ...
  ABOUT_DESCRIPTION_1:
    'Эта интерактивная игра в поисках сокровищ была создана ко Дню защиты детей 2025 года, чтобы обучение и приключения ожили в нашем местном парке.',
  ABOUT_DESCRIPTION_2:
    'С помощью QR-кодов, загадок и задач участники исследуют различные эпохи истории - от доисторического мира до будущего - решая забавные головоломки в реальных местах.',
  ABOUT_HEADER_TITLE_2: 'Создатели',
  ABOUT_DESCRIPTION_3: 'Разработчик и дизайнер сайта -',
  ABOUT_DESCRIPTION_4: 'волонтёр в',
  ABOUT_DESCRIPTION_5: 'в Тарту, Эстония, в рамках',
  ABOUT_DESCRIPTION_6:
    'Моей целью было создать что-то веселое, интерактивное и познавательное для детей всех возрастов и привнести в парк немного иновации!',
  ABOUT_HEADER_TITLE_3: 'Наши ссылки',
  ABOUT_DESCRIPTION_7: 'Волонтер, Разработчик',
  ...
  FUTURE_QUIZZ_QUESTION_1:
    'У меня есть колеса, но я редко касаюсь земли. Я летаю, как самолет, но не покидаю город. Я могу ехать, могу парить - и то, и другое я делаю без малейшего колебания. Что я?',
