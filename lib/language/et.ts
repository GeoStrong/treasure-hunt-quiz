export const estonian = {
  ...
  GAME_PAGE_HOW_IT_WORKS: 'Kuidas see töötab:',
  GAME_PAGE_HOW_IT_WORKS_LIST: [
    '1. Skaneeri QR-kood, et alustada oma seiklust.',
    '2. Igas peatuses seisad silmitsi mõistatuse või ülesandega erinevast ajast.',
