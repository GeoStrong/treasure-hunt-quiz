...
const Era1980QuizzQuestion3: React.FC = () => {
  ...
  useEffect(() => {
    setIsHintUsed(team['1980Quizz'].question3.hintUsed);
  }, [team]);
  ...
  const handleHintUsage = () => {
    setIsHintUsed(true);
    team['1980Quizz'].question3.hintUsed = true;
    team.points -= 50;
  ...
  const handlePassing = () => {
    team['1980Quizz'].question3.isCorrect = true;
    team.points += 250;
    localStorage.setItem('team', JSON.stringify(team));
  ...
  const handleSurrender = () => {
    team['1980Quizz'].question3.isCorrect = false;
    team.points -= 100;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setIsSubmitted(true);
    if (answer.toLowerCase().trim() === activeLanguage['1980_QUIZZ_ANSWER_3']) {
      setIsCorrect(true);
      team['1980Quizz'].passed = true;
      team['1980Quizz'].question3.isCorrect = true;
      team.points += 250;
    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <QuizzControls
          ...
          activeHint={activeLanguage['1980_QUIZZ_QUESTION_3_HINT']}
        />
      </form>
    </div>
  );
